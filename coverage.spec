...
%prep
%setup -q -n coverage-5.1
cd %{_builddir}/coverage-5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587926565
...
cp %{_builddir}/coverage-5.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/coverage/598f87f072f66e2269dd6919292b2934dbb20492
