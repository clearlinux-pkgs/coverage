...
%prep
%setup -q -n coverage-5.4
cd %{_builddir}/coverage-5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611674275
...
cp %{_builddir}/coverage-5.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/coverage/598f87f072f66e2269dd6919292b2934dbb20492
