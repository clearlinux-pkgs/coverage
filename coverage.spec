...
Source0  : https://files.pythonhosted.org/packages/40/05/2c1d1405edeec38114abcd404f15a35a41029b89d0514aa8ad11ffcbde81/coverage-5.3.1.tar.gz
...
%prep
%setup -q -n coverage-5.3.1
cd %{_builddir}/coverage-5.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608587609
...
cp %{_builddir}/coverage-5.3.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/coverage/598f87f072f66e2269dd6919292b2934dbb20492
