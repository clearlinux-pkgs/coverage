...
%prep
%setup -q -n coverage-6.1.1
cd %{_builddir}/coverage-6.1.1
...
cp %{_builddir}/coverage-6.1.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/coverage/598f87f072f66e2269dd6919292b2934dbb20492
