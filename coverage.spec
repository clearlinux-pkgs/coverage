...
Version  : 5.0.1
Release  : 74
URL      : https://files.pythonhosted.org/packages/06/5d/241de8854b6353a17d168223e7a16544ba560954bdfe25ef7337ba14cc28/coverage-5.0.1.tar.gz
...
%prep
%setup -q -n coverage-5.0.1
cd %{_builddir}/coverage-5.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1577136751
...
cp %{_builddir}/coverage-5.0.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/coverage/598f87f072f66e2269dd6919292b2934dbb20492
