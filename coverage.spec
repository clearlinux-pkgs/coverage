...
Source0  : https://files.pythonhosted.org/packages/56/45/6917f6de0b18a4d3b465c5b35c95df4cf1e440de37c7584275412f11f637/coverage-6.1.2.tar.gz
...
%prep
%setup -q -n coverage-6.1.2
cd %{_builddir}/coverage-6.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636645912
...
cp %{_builddir}/coverage-6.1.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/coverage/598f87f072f66e2269dd6919292b2934dbb20492
