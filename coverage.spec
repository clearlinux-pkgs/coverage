...
%prep
%setup -q -n coverage-6.0.2
cd %{_builddir}/coverage-6.0.2
...
cp %{_builddir}/coverage-6.0.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/coverage/598f87f072f66e2269dd6919292b2934dbb20492
