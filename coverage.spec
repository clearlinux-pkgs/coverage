...
%prep
%setup -q -n coverage-5.2.1
cd %{_builddir}/coverage-5.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595603546
...
cp %{_builddir}/coverage-5.2.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/coverage/598f87f072f66e2269dd6919292b2934dbb20492
